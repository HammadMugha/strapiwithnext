...
export interface ApiChategoryChategory extends Schema.CollectionType {
  collectionName: 'chategories';
  info: {
    singularName: 'chategory';
    pluralName: 'chategories';
    displayName: 'Chategory';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    chategory: Attribute.String & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::chategory.chategory',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    img: Attribute.Media;
    chategory: Attribute.Enumeration<['tshirt', 'mug', 'hoodie', 'stickers']> &
      Attribute.Required &
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::chategory.chategory': ApiChategoryChategory;
